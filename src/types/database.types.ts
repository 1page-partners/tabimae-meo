...
export type Facility={id:string;name:string;prefecture:string|null;category:'ryokan'|'hotel'|'guesthouse'|'other'|null;address?:string|null;phone?:string|null;gbp_place_id:string|null;created_at:string}
